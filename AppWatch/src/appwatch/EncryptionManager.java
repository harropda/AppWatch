...
public class EncryptionManager {
     ...
     * followed by the raw AES data. The header is broken down as follows:
     * <ul>
     ...
     * @throws EncryptionManager.InvalidKeyLengthException
     *   if keyLength is not 128, 192, or 256
     * @throws EncryptionManager.StrongEncryptionNotAvailableException
     ...
     * @throws EncryptionManager.InvalidPasswordException
     *   if the given password was not used to encrypt the data
     * @throws EncryptionManager.InvalidAESStreamException
